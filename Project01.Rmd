...
Next, run the below chunk of code line by line.  You can do this by hitting "Ctrl+Enter" on each line. The first line will load the dataset "NHANES" into your Environment tab (upper right hand window of R-studio). The second line will open up a info page with more information about the NHANES dataset in the Help tab of the lower right hand window of R-studio.
